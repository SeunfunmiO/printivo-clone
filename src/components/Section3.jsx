...
const Section3 = () => {
    return (
        <div className='container section3'>
            <div>
                <h4 style={{ paddingTop: "100px" }}>You can count on us for:</h4>
                <div className='review'>
                    <div className="card border-0 mt-1">
                        <div className="card-body card-bodyflexx d-flex justify-content-between align-items-center gap-1">
                            <div>
                                <img src="data:image/svg+xml,%3Csvg width='72' height='72' viewBox='0 0 72 72' fill='none' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath fill-rule='evenodd' clip-rule='evenodd' d='M43.5 66C54.2697 66 63 57.2697 63 46.5C63 35.7303 54.2697 27 43.5 27C32.7303 27 24 35.7303 24 46.5C24 57.2697 32.7303 66 43.5 66Z' fill='%239BD9F0'/%3E%3Cpath fill-rule='evenodd' clip-rule='evenodd' d='M36 10.5C21.9167 10.5 10.5 21.9167 10.5 36C10.5 50.0832 21.9167 61.5 36 61.5C50.0832 61.5 61.5 50.0832 61.5 36C61.5 21.9167 50.0832 10.5 36 10.5ZM13.5 36C13.5 23.5736 23.5736 13.5 36 13.5C48.4263 13.5 58.5 23.5736 58.5 36C58.5 48.4263 48.4263 58.5 36 58.5C23.5736 58.5 13.5 48.4263 13.5 36ZM37.5 19.5C37.5 18.6716 36.8283 18 36 18C35.1717 18 34.5 18.6716 34.5 19.5V34.5H22.5C21.6716 34.5 21 35.1717 21 36C21 36.8283 21.6716 37.5 22.5 37.5H36C36.8283 37.5 37.5 36.8283 37.5 36V19.5Z' fill='%23384A62'/%3E%3C/svg%3E%0A" alt="image" />
                            </div>
                            <div>
                                <div style={{ fontWeight: "600" }}>
                                    <span style={{ fontSize: "15px" }}>Fast Turnaround Within Days</span>

                                </div>
                                <div className="card-text mt-2 printivo-text" style={{ fontSize: "15px" }}> Your order gets to you within 3-7 working days via DHL or our very own Printivo Direct.</div>
                            </div>
