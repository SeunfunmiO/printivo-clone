        ...
        <header style={{padding:'25px 0px 120px'}}  >
            <div className='container'>
                ...
                <div className='form-items'>
                    <button className='border-0 my-3'>Menu</button>
                    <input className='rounded border-0' type="text" placeholder='Quick Search' required />
                </div>
                <div className='d-flex justify-content-between align-items-center'>
                    <div>
                        <h1>Quality Prints</h1>
                        <h4>Shipped to your doorstep</h4>
                        <span>What would you like to print today?</span>
                        <form className='d-flex align-items-center justify-content-between mt-2'>
                            <input className='border-0 ' type="text" placeholder='Search for Business cards, T-shirts, Mugs, etc' autoFocus required />
                            <button className='border-0 bg-transparent'> <img src="data:image/svg+xml,%3Csvg width='24' height='24' viewBox='0 0 24 24' fill='none' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath fill-rule='evenodd' clip-rule='evenodd' d='M11 4a7 7 0 100 14 7 7 0 000-14zm-9 7a9 9 0 1118 0 9 9 0 01-18 0z' fill='%23384A62'/%3E%3Cpath fill-rule='evenodd' clip-rule='evenodd' d='M15.943 15.943a1 1 0 011.414 0l4.35 4.35a1 1 0 11-1.414 1.414l-4.35-4.35a1 1 0 010-1.414z' fill='%23384A62'/%3E%3C/svg%3E" alt="search icon" width={22} /></button>
                        </form>
                    </div>
                    <img className='businessCard' style={{ position: "absolute", left: "66.5%", bottom: "16%" }} src="https://res.cloudinary.com/dmwfd0zhh/image/upload/q_auto,f_auto/v1623764552/printivo/Card3_n9kqin.png" alt="Business Card" width={450} />
